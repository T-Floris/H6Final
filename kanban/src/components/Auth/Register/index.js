...
import { Container,Section,Title, Form, Label, CreateButton, InputField, LLink, Text, Span,  Attention} from "./RegisterElements"
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await defaultvalue.post(REGISTER_URL,
                JSON.stringify( { firstName, lastName, userName, emailAddress, password }),
                {
    ...
    return (
        ...
        <Container className="App">
            {success ? (
                ...
                <Section>
                    <Text ref={errRef} className={errMsg ? "errmsg" : "offscreen"} aria-live="assertive">
                        {       errMsg.length === 1 ? errMsg
                            :   errMsg.length === 2 ? sendErrMsg(errMsg)
                            :   errMsg
                        }
                    </Text>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        />
                        <Attention id="firstnamenote" attention={firstNameFocus && firstName && !validFirstName}>
                            <FaInfoCircle />
                            1 characters.<br />
                            Letters allowed.
                        </Attention>
                        ...
                        />
                        <Attention id="lastnamenote" attention={lastNameFocus && lastName && !validLastName}>
                            <FaInfoCircle />
                            1 characters.<br />
                            Letters allowed.
                        ...
                        />
                        <Attention id="uidnote" attention={userNameFocus && userName && !validUserName}>
                            <FaInfoCircle />
                        ...
                        <Label htmlFor="email">
                            Email Address:
                            <FaCheck className={validEmailAddress ? "valid" : "hide"} />
                            <FaTimes className={validEmailAddress || !emailAddress ? "hide" : "invalid"} />
                        </Label>
                        <InputField
                            type="text"
                            id="emailaddress"
                        ...
                        />
                        <Attention id="emailaddressnote" attention={emailAddressFocus && emailAddress && !validEmailAddress}>
                            <FaInfoCircle />
                            Must be an email.
                        </Attention>
                        ...
                        <CreateButton disabled={!validFirstName || !validLastName || !validUserName || !validEmailAddress || !validPwd || !validMatch ? true : false}>Create account</CreateButton>
                    </Form>
                    <Text>
